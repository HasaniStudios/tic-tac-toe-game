{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {
    "id": "tG6ZsDCcm_3N",
    "outputId": "012f3744-86fe-4cb9-ab43-aa14cc01b177"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Writing CS457_TCPMultiConn_Client.py\n"
     ]
    }
   ],
   "source": [
    "%%writefile CS457_TCPMultiConn_Client.py\n",
    "\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "accepted connection from ('127.0.0.1', 58906)\n",
      "accepted connection from ('127.0.0.1', 58916)\n",
      "accepted connection from ('127.0.0.1', 58924)\n",
      "echoing b'Message 1 from client.Message 2 from client.' to ('127.0.0.1', 58906)\n",
      "echoing b'Message 1 from client.Message 2 from client.' to ('127.0.0.1', 58916)\n",
      "accepted connection from ('127.0.0.1', 58926)\n",
      "echoing b'Message 1 from client.Message 2 from client.' to ('127.0.0.1', 58924)\n",
      "accepted connection from ('127.0.0.1', 58934)\n",
      "echoing b'Message 1 from client.Message 2 from client.' to ('127.0.0.1', 58926)\n",
      "accepted connection from ('127.0.0.1', 58946)\n",
      "echoing b'Message 1 from client.Message 2 from client.' to ('127.0.0.1', 58934)\n",
      "accepted connection from ('127.0.0.1', 58958)\n",
      "echoing b'Message 1 from client.' to ('127.0.0.1', 58946)\n",
      "accepted connection from ('127.0.0.1', 58970)\n",
      "echoing b'Message 2 from client.' to ('127.0.0.1', 58946)\n",
      "echoing b'Message 1 from client.Message 2 from client.' to ('127.0.0.1', 58958)\n",
      "accepted connection from ('127.0.0.1', 58984)\n",
      "echoing b'Message 1 from client.' to ('127.0.0.1', 58970)\n",
      "accepted connection from ('127.0.0.1', 58998)\n",
      "echoing b'Message 1 from client.' to ('127.0.0.1', 58984)\n",
      "echoing b'Message 2 from client.' to ('127.0.0.1', 58970)\n",
      "echoing b'Message 2 from client.' to ('127.0.0.1', 58984)\n",
      "echoing b'Message 1 from client.Message 2 from client.' to ('127.0.0.1', 58998)\n",
      "closing connection to ('127.0.0.1', 58906)\n",
      "closing connection to ('127.0.0.1', 58916)\n",
      "closing connection to ('127.0.0.1', 58924)\n",
      "closing connection to ('127.0.0.1', 58926)\n",
      "closing connection to ('127.0.0.1', 58934)\n",
      "closing connection to ('127.0.0.1', 58946)\n",
      "closing connection to ('127.0.0.1', 58958)\n",
      "closing connection to ('127.0.0.1', 58970)\n",
      "closing connection to ('127.0.0.1', 58984)\n",
      "closing connection to ('127.0.0.1', 58998)\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "\n",
    "1.   Copy and paste the output portion from the server and from the client into a text file and submit this file to Canvas as proof that you have performed this lab\n",
    "2.   Submit your modified 'CS457_TCPMultiConn_Client.py' file.\n",
    "3.   Submit your Server.py file\n",
    "4.   submit your screen shots of both the client and server processes running. For this you will need to copy the server code to its own file and run it along with the client.\n",
    "\n",
    "\n",
    "Furthermore, you must add a short answer to the following questions at the end of the text file.**  \n",
    "\n",
    ">1) Do the client sockets block waiting for an event? (True/False)\n",
    "\n",
    ">2) How do asynchronous operations among clients happen? (1 or 2 sentences describing the mechanism)"
